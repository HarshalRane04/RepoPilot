...
5. Inspect and archive the uploaded release-evidence artifact from manual dry run `27059971285`.
6. Refresh release notes after measured provider evals and credentialed demo proof are available.
7. Tag `v1.0.0` only after credentialed smoke and benchmark gates pass.

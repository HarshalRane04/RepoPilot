...
- Release workflow evidence job in `.github/workflows/release.yml`; manual and tag-triggered release runs now upload deterministic local eval, source-boundary manifest, and deployment-validation artifacts before API/web/sandbox image builds.

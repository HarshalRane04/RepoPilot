...
| P1 | "Direct install" path is still manual. | Open-source users need an obvious path from clone to configured GitHub App. | Add a first-run setup checklist/wizard and optionally a GitHub App manifest flow or generated settings checklist. |
...
| PRD-03 | First-run setup checklist | P1 | Dashboard Settings shows ordered blockers and "next action" for GitHub App, OAuth, model, scanners, and OTLP. |
